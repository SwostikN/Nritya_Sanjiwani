...
export const COLLECTIONS: CollectionDef[] = [
  ...
  {
    key: "gallery_groups", label: "Gallery sections", blurb: "The groupings the gallery is divided into.",
    shownOn: "Gallery page", titleField: "title", roles: ["admin", "editor"],
    fields: [
      T("title", "Section name", { required: true }), DV("deva"),
      { key: "cols", label: "Columns", type: "select", options: ["2", "3"] },
      { key: "consent", label: "Consent-gated", type: "boolean",
        help: "Tick for sections that show participants. Nothing publishes here without signed consent." },
    ],
  },
  {
    key: "gallery_items", label: "Gallery images", blurb: "The pictures inside each section.",
    shownOn: "Gallery page", titleField: "cap", roles: ["admin", "editor"],
    groupBy: { collection: "gallery_groups", key: "group", label: "Section" },
    fields: [
